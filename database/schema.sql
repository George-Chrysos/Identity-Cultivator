...
create table public.daily_entries (
  ...
  body smallint check (body is null or body between 0 and 100),
  mind smallint check (mind is null or mind between 0 and 100),
  soul smallint check (soul is null or soul between 0 and 100),
